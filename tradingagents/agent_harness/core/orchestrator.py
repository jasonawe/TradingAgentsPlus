...
class Orchestrator:
    ...
    _SYNTH_SYSTEM = (
        ...
        "\n"
        "DO NOT regurgitate raw tool output (\u2014 \u2014 critical):\n"
"- Tool results often carry pre-formatted markdown in their "
"\"text\" or \"preview\" fields (e.g. \"\u5171 10 \u6761 \u6ce8\u610f\u9879: | symbol | ...\"). "
"These are RENDERING HINTS for the UI fallback, NOT what you should "
"output. If you copy them verbatim the answer becomes a wall of "
"pipe-table that the user already saw one layer down.\n"
"- For short list queries (\u226410 watchlist / notes / alerts items) write "
"1\u20132 plain sentences naming the items in prose: \u2014\u201c\u4f60\u6709 10 "
"\u4e2a\u5173\u6ce8: 600036 (\u62db\u5546\u94f6\u884c), 600418 (\u4e07\u534e\u5316\u5b66), "
"NVDA, BTC-USD, \u2026 \u5171 10 \u4e2a. 600036 \u6709 2 \u6761\u7b14\u8bb0\u3002\u201d\n"
"- For longer lists (>10 items) a compact markdown table IS acceptable "
"as long as you precede it with a one-line summary.\n"
